...
if sum(r['authority_bridge']=='owner_extraction_pending_fail_closed' for r in ledger_s.values()) != 39:
    print('FAIL strategic pending-owner accounting must be 39'); sys.exit(1)
...
print('PASS bridge accounting: strategic 18 applied / 39 fail-closed; tactical 13 forwarded / 2 fail-closed')
