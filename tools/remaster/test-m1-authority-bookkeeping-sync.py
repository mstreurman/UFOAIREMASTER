...
EXPECTED_PENDING = {
    "AutoResolveMission","LoadLastSave","StartMission",
}
FAMILY_TESTS = (
...
def main():
    ...
    require(len(applied)==54, f"strategic applied count must be 54, got {len(applied)}")
    ...
    for docname,doc in (("README.md",readme),("docs/README.md",docs),("architecture 093",arch)):
        require("57" in doc and "54" in doc and "3" in doc and "a26c23fee39276716023d068d3c0a99b6ba31aa0" in doc,
    ...
    print("PASS strategic authority: 57 total / 54 applied / 3 fail-closed")
