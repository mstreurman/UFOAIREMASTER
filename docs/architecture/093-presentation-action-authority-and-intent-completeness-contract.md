...
**Current implementation baseline:** `f1b46c296ec01954175c4b29373b62c2a5cdc041`
...
At implementation baseline `f1b46c296ec01954175c4b29373b62c2a5cdc041` plus the qualified defence owner extraction batch:

```text
strategic presentation-authoritative semantics: 57
  canonical-applied:                            51
  owner-extraction pending:                     6
