...
**Current implementation baseline:** `f8eba33abc59180d5994fc70554a700cd1524a59` plus StartMission canonical-owner extraction in this working tree
...
At implementation baseline `f8eba33abc59180d5994fc70554a700cd1524a59` plus the StartMission canonical-owner extraction in this working tree:

```text
strategic presentation-authoritative semantics: 57
  canonical-applied:                            56
  owner-extraction pending:                     1
